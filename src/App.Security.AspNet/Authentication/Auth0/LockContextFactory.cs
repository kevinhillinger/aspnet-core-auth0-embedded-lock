...
{
    class LockContextFactory : ILockContextFactory
    {
        ...
        public LockContextFactory(IHttpContextAccessor httpContextAccessor, IOptions<OpenIdConnectOptions> options)
        {
            this.httpContextAccessor = httpContextAccessor;
            this.options = options.Value;
        }

        public LockContext Create(string returnUrl = null)
        {
